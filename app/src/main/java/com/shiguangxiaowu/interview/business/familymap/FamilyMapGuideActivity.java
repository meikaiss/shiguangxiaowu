...
public class FamilyMapGuideActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sg__family_map_guide_activity);
        ...
        findViewById(R.id.btn_open_demo).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FamilyMapShowActivity.start(FamilyMapGuideActivity.this, memberModelList);
            }
        });
        ...
        findViewById(R.id.btn_open_fence).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FenceMapActivity.start(FamilyMapGuideActivity.this);
            }
        });
    }
